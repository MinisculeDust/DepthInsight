...
class Decoder(nn.Module):
    ...
    def forward(self, features):
        x_block_first, x_block0, x_block1, x_block2, x_block3, x_block4 = features[0], features[3], features[4], features[6], features[7], features[8]
        ...
        x_d5 = self.up5(x_d4, x_block_first)
